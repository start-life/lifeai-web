  ...
  banner.innerHTML = `
    <div class="cookie-banner-content">
      ...
      <div class="cookie-text-box">
        ...
        <p>אנו משתמשים בעוגיות (Cookies) ובכלי ניתוח לצורך שיפור חוויית הגלישה, ביצועי האתר והבטחת פעילות תקינה. בלחיצה על "אישור הכל" הנך מסכים לשימוש זה בהתאם ל<a href="terms.html">תנאי השימוש</a> ול<a href="privacy.html">מדיניות הפרטיות</a> שלנו.</p>
      </div>
    </div>
